...
<head>
	<meta charset="utf-8" />
	<title>Welcome To HEMS | Login</title>
            ...
            <div class="login-content">
                ...
                <form action="" method="POST" class="margin-bottom-0" id="loginForm">
                    ...
                    <div class="login-buttons">
                        <button type="submit" id="loginMeIn" class="btn btn-success btn-block btn-lg">Sign me in</button>
                    </div>
                    <div class="m-t-20">
                        Forgot your password? Click <a href="forgot_password.php">here</a> to reset password.
                    </div>
                </form>
            </div>
        </div>
