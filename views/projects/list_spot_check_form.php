...
$dbConnect = new MySQL();
$dbConnect->Query("SELECT spotcheck_light.status,spotcheck_light.id,spotcheck_light.comment,implementing_partners.name,outcomes.name AS outcome,spotcheck_light.form_url FROM spotcheck_light 
...
<head>
    <meta charset="utf-8" />
    <title>HEMS | List Spot Check</title>
...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">list spotcheck</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Spot Check <small>list spotcheck...</small></h1>
        <!-- end page-header -->
            ...
            <div class="col-md-12 col-xs-6">
                ...
                <div class="panel panel-primary" data-sortable-id="form-stuff-1">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">List Spot Check Form</h4>
                    </div>
