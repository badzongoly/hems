...
$dbConnect = new MySQL();
$dbConnect->Query("SELECT p.*,implementing_partners.name,implementing_partners.risk_rating FROM pmv_light LEFT JOIN implementing_partners ON pmv_light.ip_code = implementing_partners.ip_code WHERE pmv_light.status = 'approved'");
?>
<!DOCTYPE html>
