...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">User Management <small>add users...</small></h1>
        <!-- end page-header -->
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" id="form">
                            ...
                            <div class="form-group col-lg-6 col-xs-12">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="email" id="email" class="form-control" placeholder="name@domain.com" />
                            ...
                            <div class="form-group">
                                <div class="col-md-12" align="center">
                                    <button type="submit" id="add" class="btn btn-sm btn-success">Add User</button>
                                </div>
                            </div>
