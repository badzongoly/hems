...
$qury = "SELECT spot_checks.*,implementing_partners.name
                           FROM spot_checks LEFT JOIN implementing_partners ON implementing_partners.ip_code = spot_checks.vendor GROUP BY vendor";
