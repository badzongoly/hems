...
$qury = "SELECT spot_checks.*,implementing_partners.name, regions.region_name,implementing_partners.location
		  ...
		  LEFT JOIN regions ON regions.reg_code = implementing_partners.location GROUP BY location";
...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Total Spot Checks By Location</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Reports <small>total spot checks by location...</small></h1>
        <!-- end page-header -->
            ...
            <div class="col-md-12 col-xs-6">
                ...
                <div class="panel panel-primary" data-sortable-id="form-stuff-1">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Total Spot checks by Location</h4>
                    </div>
