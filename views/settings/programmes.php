...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Settings <small>programmes...</small></h1>
        <!-- end page-header -->
                        ...
                        <div class="row">
                            <form id="createUserCatForm" method="post" action="">
                                ...
                                <table class="table table-responsive table-striped table-bordered" align="center">
                                    ...
                                    <input type="hidden" name="do" value="CreateProgrammes">
