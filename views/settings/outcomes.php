...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Settings <small>outcomes...</small></h1>
        <!-- end page-header -->
                        ...
                        <div class="row">
                            <form id="createUserCatForm" method="post" action="">
                                ...
                                <table class="table table-responsive table-striped table-bordered" align="center">
                                    ...
                                    <input type="hidden" name="do" value="CreateOutcomes">

                                </table>
                                <hr>
                            </form>
                            <div>
                                <p align="center" style="display: none; color: limegreen;" id="wait"><img src="../../images/495.gif" > Adding outcomes. Please wait....</p>
                            </div>
