...
class Password extends MySQL{
  ...
  public function getMaxSymbols() {
   ...
   public function forgotpwd($username){
    ...
    public function newUserPassword($username,$password,$token){
        ...
        if(!empty($username)){
                ...
                $mess = "<html>
                                        <head>
                                         <title>TERM New User Account Creation</title>
                                        </head>
                                        <body>
                                         <p>Welcome to TERM</p>
                                         <p>
                                         Hello,<br/>
                                         An account was recently created for you in the GTUC TERM ERP. The URL to this system is <strong>erp.gtuc.edu.gh</strong>
                                         </p>
                                         ...
                                         <p>Click the link below to activate your account</p><br>
                                            <p><a target='_blank' href='http://erp.gtuc.edu.gh?token=$encrytedToken'>http://erp.gtuc.edu.gh?token=$encrytedToken</a></p>
                                        </body>
                                        </html>";
